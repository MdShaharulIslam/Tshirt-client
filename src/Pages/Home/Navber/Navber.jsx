      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="relative flex items-center space-x-4">
          <div className="relative md:block">
            <input
              type="text"
              className="w-full py-2 pl-4 pr-10 text-gray-700 bg-white border-none md:border lg:border-black md:pl-10 md:pr-4 rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:md:border-gray-600 focus:border-blue-400 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300"
              placeholder="Search"
            />
          ...
          <Link
            to="#"
            className="text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-300"
          >
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="flex flex-col items-center space-y-2 py-4">
            ...
            <div className="relative mt-2 w-full px-4"></div>
          </div>
        </div>
      )}
    </nav>
