...
const Banner = () => {
    return (
        ...
        <div className="w-full lg:w-1/2 p-6 lg:p-12 flex flex-col justify-center text-center lg:text-left">
          ...
          {/* Stats Section */}
          <div className="flex justify-center lg:justify-start items-center space-x-8 mt-8">
          ...
          />
                ...
                <div className='bg-black w-full items-center p-4'>
                    <div className="lg:flex md:flex items-center text-center justify-evenly mt-4">
                        <p className="text-center text-white dark:text-gray-400 font-extrabold text-4xl">VERSACE</p>
                        <p className="text-center text-white dark:text-gray-400 font-extrabold text-4xl mx-4">ZARA</p>
                        <p className="text-center text-white dark:text-gray-400 font-extrabold text-4xl mx-4">GUCCI</p>
                        <p className="text-center text-white dark:text-gray-400 font-extrabold text-4xl mx-4">PRADA</p>
                        <p className="text-center text-white dark:text-gray-400 text-4xl mx-4">Calvin Klein</p>
                    </div>
                </div>
            </div>
        </div>
